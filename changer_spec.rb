...
describe CoinChanger do
	...
	it "gives lots of change for close to a dollar" do
		expect(changer.make_change_for(99)).to eq [50,25,10,10,1,1,1,1]
	end
	it "gives quarters for a dollar" do
		expect(changer.make_change_for(100)).to eq [50,50]
	end

	it "gives a 50 cent piece for 50 cents" do
		expect(changer.make_change_for(50)).to eq [50]
	end
end
